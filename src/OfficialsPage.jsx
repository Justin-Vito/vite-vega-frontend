...
const OfficialsPage = () => {
  ...
  // State to track the selected sort option and search term
  ...
  // Update sort option when the dropdown changes
  ...
  // Sort the residents array based on the selected sort option
  ...
  // Filter the sorted array based on the search term (name only)
